...
train_file = open('eng.train.v1.txt', 'r')
dev_file = open('eng.testa.v1.txt', 'r')
test_file = open('eng.testb.v1.txt', 'r')

train_raw = open('ner.train.raw', 'w')
train_ref = open('ner.train.ref', 'w')

dev_raw = open('ner.dev.raw', 'w')
dev_ref = open('ner.dev.ref', 'w')

test_raw = open('ner.test.raw', 'w')
test_ref = open('ner.test.ref', 'w')

tags_file = open('en.ner.tags', 'w')
tag_names = []
